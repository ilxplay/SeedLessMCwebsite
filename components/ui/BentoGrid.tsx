...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background: "rgb(10,8,35)",
        backgroundColor: "linear-gradient(90deg, rgba(14,12,50,1) 0%, rgba(108,108,223,1) 35%, rgba(110,78,171,1) 100%);"
    ...
    >
      <div className={`${id === 6} && flex justify-center h-full`}>
        ...
        <div className={cn(titleClassName, "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10"
          ...
          <div className="font-sans text-lg font-bold text-neutral-600 dark:text-neutral-200 lg:text-3xl max-w-96 z-10">
            {title}
          </div>
        </div>
      </div>
